...
class ReservationService
{
    ...
    {
        $reservations = Reservation::with("house", "user", "status")->get();
        return $reservations;
    }
    public function store(array $data)
    {
        ...
        return $reservation->load('house', 'user', 'status');
    }
    ...
    public function canReserve(
        int $houseId,string|Carbon $startDate,string|Carbon $endDate): bool {
        $start = $startDate instanceof Carbon ? $startDate->copy() : Carbon::parse($startDate);
    ...
    public function cancelReservation(Reservation $reservation){
        ...
        $reservation->save();
        return $reservation->load('house.images','house.address', 'status');
    }
