                ...
                <div class="auth-card-body auth-card-body-tall">
                    <form method="POST" action="{{ route('login') }}" novalidate>
                        ...
                        <div class="input-group field-lg mb-2 reveal delay-2">
                            ...
                            <input id="adminPhone" type="tel" class="form-control" name="phone"
                                placeholder="e.g. 09xxxxxxxx" value="{{ old('phone') }}" required
                        ...
                        <div class="input-group field-lg mb-2 reveal delay-2">
                            <button class="input-group-text" type="button" data-toggle-password="#adminPassword"
