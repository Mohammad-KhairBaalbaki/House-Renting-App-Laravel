                        ...
                        <div class="res-card">
                            ...
                            <div class="res-meta">
                                <div class="d-flex justify-content-between align-items-start gap-2">
                                    ...
                                    <div class="text-end">
                                        <span
                                            class="status-pill {{ $pill }}">{{ $r->status?->type ?? '-' }}</span>
                                ...
                                <div class="res-grid">
                                    <div class="res-k">
                                        ...
                                        <div class="v">{{ \Carbon\Carbon::parse($r->start_date)->format('Y-m-d') }}
                                        </div>
                                    </div>
                                    <div class="res-k">
                                        <div class="k">End</div>
                                        <div class="v">{{ \Carbon\Carbon::parse($r->end_date)->format('Y-m-d') }}
                                        </div>
                                    </div>
                                    <div class="res-k">
